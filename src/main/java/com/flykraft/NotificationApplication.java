...
public class NotificationApplication {
    public static void main(String[] args) {
        ...
        com.flykraft.service.notification.NotificationService notificationService = new com.flykraft.service.notification.NotificationService(subscriptionService, stakeHolderService);
