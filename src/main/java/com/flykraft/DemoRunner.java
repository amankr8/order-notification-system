...
public class DemoRunner {
    public static void runDemo(CustomerService customerService, VendorService vendorService, DeliveryPartnerService deliveryPartnerService, OrderService orderService, SubscriptionService subscriptionService) {
        try {
            ...
            subscriptionService.unsubscribeFromStatuses(customer1.getStakeHolderId(), Set.of(OrderStatus.DELIVERED.getId()));
            ...
            subscriptionService.subscribeToStatuses(customer1.getStakeHolderId(), Set.of(OrderStatus.DELIVERED.getId()));
